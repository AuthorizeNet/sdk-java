...
import net.authorize.apicore.contract.v1.UpdateCustomerShippingAddressRequest;
import net.authorize.apicore.contract.v1.UpdateCustomerShippingAddressResponse;
