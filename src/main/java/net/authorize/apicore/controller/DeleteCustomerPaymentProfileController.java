...
import net.authorize.apicore.contract.v1.DeleteCustomerPaymentProfileRequest;
import net.authorize.apicore.contract.v1.DeleteCustomerPaymentProfileResponse;
