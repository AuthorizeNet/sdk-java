...
import net.authorize.apicore.contract.v1.SendCustomerTransactionReceiptRequest;
import net.authorize.apicore.contract.v1.SendCustomerTransactionReceiptResponse;
