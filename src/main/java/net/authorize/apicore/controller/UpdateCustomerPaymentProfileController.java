...
import net.authorize.apicore.contract.v1.UpdateCustomerPaymentProfileRequest;
import net.authorize.apicore.contract.v1.UpdateCustomerPaymentProfileResponse;
