...
public enum ResponseField {
	...
	PREPAID_CARD(AuthNetField.X_PREPAID_CARD.getFieldName()),
	PREPAID_CARD_REQUESTED_AMOUNT(AuthNetField.X_PREPAID_CARD_REQUESTED_AMOUNT.getFieldName()),
	PREPAID_CARD_APPROVED_AMOUNT(AuthNetField.X_PREPAID_CARD_APPROVED_AMOUNT.getFieldName()),
	PREPAID_CARD_BALANCE_ON_CARD(AuthNetField.X_PREPAID_CARD_BALANCE_ON_CARD.getFieldName()),
	ID(AuthNetField.X_ID.getFieldName()),
	SUBSCRIPTION(AuthNetField.X_SUBSCRIPTION.getFieldName()),
	PAYMENT_NUM(AuthNetField.X_PAYMENT_NUM.getFieldName()),
	RESERVED_11(null),
	RESERVED_12(null),
	RESERVED_13(null),
	RESERVED_14(null),
