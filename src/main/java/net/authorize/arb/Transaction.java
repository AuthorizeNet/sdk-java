...
public class Transaction extends net.authorize.Transaction {
	...
	private void addSubscriptionToRequest(BasicXmlDocument document, Subscription subscription){
		...
		if (subscription.getProfile() != null && StringUtils.isNotEmpty(subscription.getProfile().getCustomerProfileId()) && StringUtils.isNotEmpty(subscription.getProfile().getCustomerPaymentProfileId())) {
