...
public class SecurePaymentContainerControllerTest extends ApiCoreTestBase {
	...
	public void mockSecurePaymentContainerControllerTest()
	{
		...
		opaqueDataType.setDataValue("test-value");
		mockResponse.setOpaqueData(opaqueDataType);
		...
		Assert.assertNotNull(controllerResponse.getOpaqueData());
		logger.info(String.format("SecurePaymentContainer: Details:%s", controllerResponse.getOpaqueData().getDataValue()));
	}
}
