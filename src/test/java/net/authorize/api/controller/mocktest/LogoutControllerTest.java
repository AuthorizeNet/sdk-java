...
public class LogoutControllerTest extends ApiCoreTestBase {
	...
	@Test
	public void mockLogoutControllerTest()
	{
		//define all mocked objects as final
		final IApiOperation<LogoutRequest, LogoutResponse> mockController = getMockController();
		
		final LogoutRequest mockRequest = factory.createLogoutRequest();
		mockRequest.setRefId(refId);
		
		final LogoutResponse   mockResponse = factory.createLogoutResponse();
		...
		LogoutResponse controllerResponse = mockController.getApiResponse();
		
		Assert.assertNotNull(controllerResponse);
		logger.info(String.format("Logout: Details:%s", controllerResponse));
	}
}
